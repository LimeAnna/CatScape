...
class Menu:
    ...
    def __init__(self, window):
        self.window = window
        self.surf = pygame.image.load('./asset/menuCE.png')
    ...
    def run(self, ):
        ...
        while True:
            ...
            self.menu_text(65, "Cat", COLOR_PINK, ((WIN_WIDTH / 2), 70))
            self.menu_text(70, "Scape", COLOR_PINK, ((WIN_WIDTH / 2), 120))

            for i in range(len(MENU_OPTION)):
                if i == menu_option:
                    self.menu_text(30, MENU_OPTION[i], COLOR_PINK, ((WIN_WIDTH / 2), 200 + 30 * i))
                else:
